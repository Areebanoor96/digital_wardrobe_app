...
void main() {
  ...
  Future<void> pumpProfile(
    ...
    await tester.pumpWidget(
      ProviderScope(
        overrides: <Override>[
          profileProvider.overrideWith((ref) async => override ?? profile),
  ...
  testWidgets('Insights & Analytics opens the Analytics screen', (
    ...
    await tester.tap(find.text('Insights & Analytics'));
    await tester.pumpAndSettle();

    expect(find.byType(AnalyticsScreen), findsOneWidget);
    expect(find.text('Insights & Analytics'), findsNothing);
  });
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final _EditNameProfileRepository repository = _EditNameProfileRepository(
        holder,
      );
